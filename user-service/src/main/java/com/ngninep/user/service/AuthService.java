...
import com.ngninep.user.security.JwtUtil;
...
public class AuthService {
    ...
    public String register(RegisterRequest request) {
        ...
        if (existing.isPresent()) {
            ...
            if (customer.isVerified()) {        // ✅ Lombok: isVerified()
        ...
        Customer newCustomer = Customer.builder()
                ...
                .verified(false)                // ✅ builder: .verified()
                .banned(false)                  // ✅ builder: .banned()
                .role(Role.ROLE_USER)
                .build();
    ...
    public String verifyOtp(VerifyOtpRequest request) {
        ...
        if (customer.isVerified()) {            // ✅ isVerified()
        ...
        // OTP valid — set is_verified = true
        customer.setVerified(true);             // ✅ setVerified()
